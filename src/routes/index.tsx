...
import { Hammer, Home as HomeIcon, Palette } from "lucide-react";
...
function HomePage() {
  ...
  const heroBg = get("hero_image_url") || heroImage;
      ...
      <section className="relative isolate min-h-[70vh] md:min-h-[85vh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[70vh] md:min-h-[85vh] max-w-7xl flex-col items-center justify-center px-4 py-20 text-center text-white">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary-dark shadow-elegant">
              <a href="#book">{t({ ar: "احجز زيارة منزلية", fr: "Réserver une visite" })}</a>
            </Button>
